...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(BAD_REQUEST)
    public ResponseEntity<ResponseData> handleValidationException(ValidationException ex, WebRequest request) {
        String errorId = generateErrorId();
        logger.warn("Validation error [{}]: {} - Request: {}",
                errorId, ex.getMessage(), getRequestInfo(request));
    ...
    public ResponseEntity<ResponseData> handleSchoolNotFoundException(SchoolNotFoundException ex, WebRequest request) {
        String errorId = generateErrorId();
    ...
    @ResponseStatus(NOT_FOUND)
    public ResponseEntity<ResponseData> handleGroupNotFoundException(GroupNotFoundException ex, WebRequest request) {
        String errorId = generateErrorId();
    ...
    @ResponseStatus(NOT_FOUND)
    public ResponseEntity<ResponseData> handleCourseNotFoundException(CourseNotFoundException ex, WebRequest request) {
        String errorId = generateErrorId();
    ...
    @ResponseStatus(NOT_FOUND)
    public ResponseEntity<ResponseData> handleTeacherNotFoundException(TeacherNotFoundException ex, WebRequest request) {
        String errorId = generateErrorId();
    ...
    @ResponseStatus(NOT_FOUND)
    public ResponseEntity<ResponseData> handleStudentNotFoundException(StudentNotFoundException ex, WebRequest request) {
        String errorId = generateErrorId();
    ...
    @ResponseStatus(BAD_REQUEST)
    public ResponseEntity<ResponseData> handleConstraintViolationException(DataIntegrityViolationException ex, WebRequest request) {
        String errorId = generateErrorId();
    ...
    @ResponseStatus(BAD_REQUEST)
    public ResponseEntity<ResponseData> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request) {
        String errorId = generateErrorId();
